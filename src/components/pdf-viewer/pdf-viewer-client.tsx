...
const THEMES: Record<ThemeName, ThemeConfig> = {
  parchment: {
    name: "parchment",
    label: "Giấy cổ",
    bg: "bg-[#fbf9f4] text-[#2d2418]",
    workspace: "bg-[#f3eee2]",
    text: "text-[#2d2418]",
    toolbar: "bg-[#fbf9f4]/95 border-[#e8dfcf] text-[#2d2418]",
    card: "bg-white border-[#e8dfcf] shadow-sm",
    divider: "border-[#e8dfcf]",
    badge: "bg-[#ebe2cf] text-[#4c6b54] border-[#d8ccb4]",
    accentBtn: "hover:bg-[#ebe2cf] text-[#2d2418]/80 hover:text-[#4c6b54]",
    activeBtn: "bg-[#ebe2cf] text-[#4c6b54] font-semibold",
  },
  sepia: {
    name: "sepia",
    label: "Hoài cổ",
    bg: "bg-[#f4ebd9] text-[#382613]",
    workspace: "bg-[#e9dcbf]",
    text: "text-[#382613]",
    toolbar: "bg-[#f4ebd9]/95 border-[#dfccaa] text-[#382613]",
    card: "bg-[#fdfaf3] border-[#dfccaa] shadow-sm",
    divider: "border-[#dfccaa]",
    badge: "bg-[#dfccaa] text-[#7c5329] border-[#cdb791]",
    accentBtn: "hover:bg-[#dfccaa] text-[#382613]/80 hover:text-[#7c5329]",
    activeBtn: "bg-[#dfccaa] text-[#7c5329] font-semibold",
  },
  dark: {
    name: "dark",
    label: "Đọc đêm",
    bg: "bg-[#141210] text-[#eae0d2]",
    workspace: "bg-[#0c0a09]",
    text: "text-[#eae0d2]",
    toolbar: "bg-[#141210]/95 border-[#28231e] text-[#eae0d2]",
    card: "bg-[#1c1916] border-[#28231e] shadow-sm",
    divider: "border-[#28231e]",
    badge: "bg-[#28231e] text-[#8ea48a] border-[#38322a]",
    accentBtn: "hover:bg-[#24201b] text-[#eae0d2]/80 hover:text-[#8ea48a]",
    activeBtn: "bg-[#24201b] text-[#8ea48a] font-semibold",
  },
};
